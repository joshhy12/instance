...
<?php
	...
	<head>
	       ...
	       <meta="utf-8"/>
	       <meta name="viewpoint" content="width=device-width,intial_scale=1"/>
	...
	<body style="background: #d3d3d3;">
		...
		<div class="container-fluid">
		    <div class="navbar-header">
		         <img src="images/logo.png" width="70px"height="50px"/>
	...
	<ul id="menu" class="nav menu">
		<li>
			<a style="font-size:18px;border-bottom:1px solid #d3d3d3;" href="home.php"><i class="glyphicon glyphicon-home"></i>Home</a>
		</li>
	
		<li>
			<a style="font-size:18px;border-bottom:1px solid #d3d3d3;" href=""><i class="glyphicon glyphicon-tasks"></i>Accounts</a>
		<ul style="list-style: none;">
			<li>
				<a href="admin.php" style="font-size:15px;"><i class="glyphicon glyphicon-user"></i>Admin</a></li>
	...
	Books</a></li>
	<li><a style="font-size:18px;border-bottom:1px solid#d3d3d3d;" href=""><i class="glyphicon glyphicon-th"></i>Transaction
	</a>
...
<li><a style="font-size:18px;border-bottom:1px solid#d3d3d3;" href=""><i class="glyphicon glyphicon-cog"></i>settings</a>
	<ul style="list-style-type: none;">
		<li><a style="font-size:15px;" href="logout.php"><i class="glyphicon glyphicon-log-out"></i>Logout</a></li>
				...
				<button id="show_admin" type="button" style="display:none;" class="btn btn-success"><span class="glyphicon-circle-arrow-left"></span>Back</button>
				<br/>
				<br/>
...
<?php
	...
	?>
	    ...
	    <div class="col-lg-6">
		<form method="POST" action="save_admin_quer.php" enctype="multipart/form-data"><div class="form-group">
		...
		<div class="form-group">
		<button class="btn btn-primary" name="save_admin"><span class="glyphicon-save"></span>Submit</button></span>
	</div>
</form>
</div>
</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$result=$('<center><label>Deleting...</label></centre>');
