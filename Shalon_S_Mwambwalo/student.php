...
<body style="background-color: #d3d3d3;">
	...
	<ul id="menu" class="nav menu">
		<li><a style="font-size:18px;border-bottom:1px solid #d3d3d3;" href="home.php"><i class="glyphicon glyphicon-home"></i>Home</a>
		</li>
...
<div class="col-lg-9 well" style="margin-top:60px;">
	...
	<button id="add_student" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Add new</button>
			<button id="show_student" type="button" style="display: none;" class="btn btn-sucess"><span class="glyphicon glyphicon-circle-arrow-left"></span>Back</button>
		</br>
	</br>
	<div id="student_table">
		<table id="table" class="table table-bordered"> 
			<thead class="alert-sucess">
				<tr>
					<th>Student ID</th>
					<th>Firstname</th>
					<th>Middlename</th>
		...
		<tbody>
			...
			$qstudent=mysqli_query($conn," SELECT * FROM `student`");

			while($fstudent=mysqli_fetch_array($qstudent)){
			...
			<tr>
				...
				<td><a value="<?php echo $fstudent['student_no']?>"class="btn btn-danger delstudent_id"><span class="glyphicon glyphicon-remove"></span>Delete</a>
					<a class="btn btn-warning estudent_id" value="<?php echo $fstudent['student_no']?>"><span class="glyphicon glyphicon-edit"></span>Edit</a></td>
				</tr>
				<?php
			}
			?>
		...
		<br/>
		<br/>
		<nav class="navbar navbar-default navabar-fixed-bottom">
			<div class="container-fluid">
