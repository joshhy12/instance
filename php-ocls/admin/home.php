<h1>BCSTech <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-cyan elevation-1"><i class="fas fa-umbrella"></i></span>
          ...
          <!-- /.col -->
          <div class="row-12 row-sm-6 row-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-yellow elevation-1"><i class="fas fa-flag"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">wait Orders</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="row-12 row-sm-6 row-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-black elevation-1"><i class="fas fa-wifi"></i></span>
