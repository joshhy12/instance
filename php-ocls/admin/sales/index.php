        ...
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-secondary btn-sm"><i class="fa fa-check"></i> check</button>
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-#800000 btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> Printf</button>
                </div>
            </div>
        </form>
        <hr>
