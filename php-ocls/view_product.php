...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-start">
            <div class="col-md-6">
                <div class="card-img-top mb-5 mb-md-0 border border-black" loading="lazy" id="display-img">
                ...
                <div class="mt-2 row gx-2 gx-lg-3 row-cols-4 row-cols-md-3 row-cols-xl-4 justify-content-start">
                    ...
                    ?>
                    <div class="col">
                        <a href="javascript:void(0)" class="view-image <?php echo $k == 2 ? "ON":'' ?>"><img src="<?php echo validate_image('uploads/product_'.$id.'/'.$img) ?>" loading="lazy"  class="img-thumbnail" alt=""></a>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                Tsh: <span id="price"><?php echo number_format($price) ?></span>
                <br>
               /* <span><small><b>Available Stock:</b> <span id="avail"><?php echo $inv[0]['quantity'] - ($sold ?? 0) ?></span></small></span>*/
                ...
                <div class="d-flex">
                    ...
                    <button class="btn btn-outline-blue flex-shrink-0" type="submit">
                ...
                <table class="table table-sm table-bordered my-3">
                    ...
                    <tbody>
                        <tr>
                            <th colspan="2" class='text-center bg-magenta'>Performance</th>
                        </tr>
                        <tr>
                            <th>Processor</th>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" class='text-center bg-success'>IO and Ports</th>
                        </tr>
                        <tr>
                            <th>IO Ports</th>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" class='text-center bg-primary'>Connectivity</th>
                        </tr>
                        <tr>
                            <th>WIFI</th>
                            <td>
